...
//  Afiliacion
//
//  Created by stefanini on 11/8/17.
//  Copyright © 2017 stefanini. All rights reserved.
//

import UIKit
import CoreData
class Aceptadas: UIViewController,XMLParserDelegate,UITableViewDelegate,UITableViewDataSource {
    ...
    @objc func verBuzonb(){
        ...
        repeat {
            if buzonB[num].estatus_b == 2 {
                ...
                ExtDatos()
                print("ID",buzonB[num].id_solicitud_b)
